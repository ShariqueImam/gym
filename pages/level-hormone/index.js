  ...
  return (
    ...
    <div className="flex flex-col items-center ">
      ...
      <div className="flex flex-col text-gray-100 mt-8 w-[90%] md:w-[40%] lg:w-[30%] mx-auto">
        ...
        <p className="my-4">
          Both cortisol and testosterone levels increase linearly in response to
          physical exercise.
        </p>
        <p className="my-4">
          However, it is of vital importance to consider them in order to reach
          a specific threshold of exercise intensity.
        </p>
        <p className="my-4">
