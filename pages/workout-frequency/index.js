  ...
  return (
    <>
      ...
      <Animator>
        ...
        {!Show && (
          <div onClick={handleClick1} className={`${Show ? 'mt-4':'mt-24'} md:mt-4 w-[90%] md:w-[15%] lg:w-[10%] mx-auto`}>
            <Button dis={Click.length > 0 ? false : true} text={"Continue"} />
          </div>
        )}
        {Show && (
          <Link href={`${Click.length > 0 ? "/workout-duration" : ""}`}>
            <div onClick={() => Cookies.set("workout-frequency", Click)} className={`${Show ? 'mt-4':'mt-36'} md:mt-4 w-[90%] md:w-[15%] lg:w-[10%] mx-auto`}>
