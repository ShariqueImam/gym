...
const style = {
  wrapper:
    "my-12 bg-neutral-900 border-2 border-stone-400 px-12 md:px-24 py-6 md:py-16 flex flex-col md:flex-row w-[95%] md:w-[60%] lg:w-[50%] mx-auto",
...
const MoneyBack = () => {
  return (
    <div className={style.wrapper}>
      ...
      <Image src={'/final/download.webp'} height={500} width={700}/>
    </div>
  );
};
