...
const style = {
  wrapper:
    "border-b-[20px] hover:border-orange-[600] transition duration-[300ms] cursor-pointer my-4 flex px-3 md:px-7 py-3 md:py-4 border-2 border-stone-600 bg-neutral-900 hover:bg-stone hover:border-orange-600",
...
const SinglePlanCard = ({ text, per, total }) => {
  return (
