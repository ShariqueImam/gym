...
const style = {
  wrapper: "cursor-pointer flex items-center jusitify-center bg-orange-600 max-w-fit px-6 py-2 md:px-8 md:py-3 lg:px-8 lg:py-3 hover:bg-orange-500 transition duration-[400ms] rounded mx-auto my-6",
