...
const style = {
  wrapper:
    "flex z-10 bg-opacity-[0.5] bg-[rgba(0,0,0,0.7)] w-[100vw] h-[90vh] text-gray-100 absolute",
  container1: "w-[30%] md:w-[70%] h-[90vh]",
  container2: "w-[70%] md:w-[30%] text-stone-300 bg-neutral-800 h-[90vh]",
};
const variants ={
    initial:{x:500},
